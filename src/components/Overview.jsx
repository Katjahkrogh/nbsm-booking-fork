  ...
  return (
    <div className="flex flex-col md:items-center mb-20 text-green ">
        ...
        <div className="mb-10">
          ...
          <div className="bg-lightBeige w-full md:w-[500px] rounded-xl py-6 px-6 flex flex-col gap-4">
            ...
            <div className="flex gap-6 text-lightGreen text-sm">
              <p>
                {format(new Date(selectedBooking.day), " dd. MMMM", {
                  locale: da,
                })}
              </p>
      ...
      <div className="flex items-center w-full md:w-[500px]">
        <p >Aflysningspolitik</p>
        <Tooltip text={"Aflysning skal senest 24 timer inden. Du skal aflyse via DM på Instagram eller via telefon."} />
      </div>

      <div className="flex items-top w-full md:w-[500px] ">
        <label
          htmlFor={"politik"}
          className="cursor-pointer rounded-xl py-4 pl-4 text-xs md:text-sm text-lightGreen relative flex items-center"
        >
          <input
            type="checkbox"
            name="politik"
          ...
          Jeg har læst og accepterer afbudspolitikken
        </label>
      </div>
      <PrimaryBtn
        setStep={setStep}
